...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <a href="{{ route('client.messages') }}" class="btn btn-outline-secondary me-3">
            ...
            <div class="ms-3">
                <h4 class="mb-0">CGV Motors</h4>
                <small class="text-muted">Sujet: {{ $sujet }}</small>
            </div>
        </div>
    </div>
            ...
            <div class="message {{ $message->sender_id === auth()->id() ? 'message-sent' : 'message-received' }}">
                <div class="message-content">
                    <div class="message-header">
                        <strong>{{ $message->sender_id === auth()->id() ? 'Vous' : 'CGV Motors' }}</strong>
    ...
    <div class="reply-form">
        <form action="{{ route('client.reply', $sujet) }}" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
